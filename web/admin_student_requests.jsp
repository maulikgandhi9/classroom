<%-- 
    Document   : admin_student_requests
    Created on : 5 Jan, 2022, 11:44:33 AM
    Author     : maulik
--%>
                    ...
                    <form class="form-default" action="admin_student_requests_action.jsp" method="POST">
                        <table class="table">
                            <tr>
                                ...
                                <th scope = "row" class="roll_no">Student ID</th>
                            ...
                            <%
                                try {
                                    ...
                                    String sql = "select student_id, name, course from student where is_approved = 0";
                            ...
                            <div class="table-row">
                                ...
                                <td>
                                    <div class="accept"><input type="checkbox" name="ad" value="<%= rs.getString(1)%>"></div>
                                </td>
                            </div>
                            </tr>
