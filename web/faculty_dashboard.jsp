<%-- 
    ...
    Created on : 5 Jan, 2022, 3:52:54 PM
    Author     : maulik
--%>
                                        ...
                                        <div class="main-menu d-none d-lg-block">
                                            <nav>
                                                <ul id="navigation">
                                                    ...
                                                    <li><a href="qna_faculty.jsp">Q/A Forum</a></li>
                                                    <!-- Button -->
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-7 col-md-12">
                                    <div class="hero__caption">
                                        ...
                                        <p data-animation="fadeInLeft" data-delay="0.4s">Put video lectures, curate study materials and address doubts at one place.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
