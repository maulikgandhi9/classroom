                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-7 col-md-12">
                                    <div class="hero__caption">
                                        <h1 data-animation="fadeInLeft" data-delay="0.2s">Welcome<br><%= session.getAttribute("student")%>
                                        </h1>
                ...
                <div class="container">
                    ...
                    <div class="courses-actives">
                        <%
                            ...
                            ResultSet rs = stmt.executeQuery("select category,question,poser,answerer,is_answered,question_id from qna");
                        ...
                        <div class="properties pb-20">
                            <div class="properties__card">
                                ...
                                <div class="properties__caption">
                                    ...
                                    %>
<!--                                    <form action="answer_page.jsp" method="get"> 
                                        <input type="submit" class="border-btn border-btn2" value="Open"></input>
                                        <hidden name="qid" value=""></hidden>
                                ...
                                <div class="modal-body">
                                    <form action="answer" method="post">
                                        ...
                                        <div class="container text-center">
                                            <input type="hidden" name="qid" value="<>"></input>
